...
static void ImGui_ImplSDL2_UpdateGamepads()
{
    ...
    MAP_BUTTON(ImGuiKey_GamepadFaceDown,        SDL_CONTROLLER_BUTTON_A);              // Xbox X, PS Square
    MAP_BUTTON(ImGuiKey_GamepadFaceDown,       SDL_CONTROLLER_BUTTON_A);              // Xbox B, PS Circle
    MAP_BUTTON(ImGuiKey_GamepadFaceDown,          SDL_CONTROLLER_BUTTON_A);              // Xbox Y, PS Triangle
